#============================================================================
# ESTATÍSTICA - MEDIDA DE ASSIMETRIA (SKEWNESS)
# Versão 1.00 (2019) - 05.09.2019
# Autor: Prof. Giovanni Leopoldo Rozza (2019)
#============================================================================

#-------------------------------------------
# FUNCAO funcao_CalculaAssimetria
#-------------------------------------------
# calcula a assimetria da distribuição retorna um valor
# a entrada sao os dados da amostra

funcao_CalculaAssimetria <- function(dadosEntrada) 
{
  ...
  {
    numerador   <- numerador + (dadosEntrada[nConta]- media)^3
  }
  numerador <-numerador/length(dadosEntrada)
  
  denominador <- desvio_padrao^3
...
linha<- sprintf("Medida de Assimetria : % 8.3f",funcao_CalculaAssimetria(dados))  # prepara o texto formatando a variável numérica para 99999.99
